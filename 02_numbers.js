...
// console.log(Math.round(4.9)); // Метод Math.round() возвращает число, округлённое к ближайшему целому.
// console.log(Math.trunc(4.9)); // Функция Math.trunc() возвращает целую часть числа путём удаления всех дробных знаков.
// console.log(Math.random()); // рандомное значение числа
// // console.log(Math.sin()) // любая тригонометрия

//4 Example   // рандомное целое число  1 - чтобы макс число не исчезало
